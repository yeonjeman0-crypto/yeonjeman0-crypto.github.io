...
window.I18N = {
    ko: {
        ...
        'careers.portals.title': '채용 플랫폼',
        'record.eyebrow': '12 · Record', 'record.title': '운항·인증 기록',
        'record.lead': '검사·인증·선대 변동 기록',
        'careers.eyebrow': '13 · Crew Recruitment', 'careers.title': '해상직원 채용정보',
        'careers.lead': '현재 모집 중인 해상·육상 직위',
        ...
        'contact.lane.owner': '선주·용선 문의',
        'contact.lead': '선주·용선 문의 채널 안내',
    ...
    en: {
        ...
        'careers.portals.title': 'Recruitment Platforms',
        'record.eyebrow': '12 · 운항·인증 기록', 'record.title': 'Operational Record',
        'record.lead': 'Inspections, certifications and fleet changes',
        'careers.eyebrow': '13 · 해상직원 채용', 'careers.title': 'Maritime Crew Recruitment',
        'careers.lead': 'Current sea-going and shore openings',
        ...
        'contact.lane.owner': 'Owner & Charterer Enquiries',
        'contact.eyebrow': '14 · 문의', 'contact.title': 'Contact',
        'contact.lead': 'Enquiry channels for owners and charterers',
