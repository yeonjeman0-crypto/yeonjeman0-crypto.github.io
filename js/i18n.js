...
window.I18N = {
    ko: {
        ...
        'commit.s3': '리스크 관리', 'commit.s3d': '검사·심사·운항 리스크 사전 점검',
        ...
        'contact.lead': '문의 이메일을 선택하거나 해상직원 입사지원서를 내려받으세요.',
    ...
    en: {
        ...
        'contact.lead': 'Choose an email service for inquiries or download the maritime crew application form.',
